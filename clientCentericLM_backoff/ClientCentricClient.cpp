...
bool ClientCentricClient::re_inquire_shared_lock(ClientContext &ctx, int lock_id) {
...
bool ClientCentricClient::request_exclusive_lock(ClientContext &ctx, int lock_id) {
...
bool ClientCentricClient::request_shared_lock(ClientContext &ctx, int lock_id) {
...
int ClientCentricClient::release_exclusive_lock(ClientContext &ctx, int lock_id) {
...
int ClientCentricClient::release_shared_lock(ClientContext &ctx, int lock_id) {
...
int ClientCentricClient::start_benchmark(ClientContext &ctx) {
