...
g++ utils.o obj/RDMACommon.o obj/BaseContext.o obj/ClientContext.o obj/ServerContext.o obj/LockServer.o -libverbs -lpthread -o executables/serverCentricLM/LockServer

g++ -c -Wno-write-strings -std=c++11 serverCentricLM/LockClient.cpp -o obj/LockClient.o
g++ utils.o obj/RDMACommon.o obj/BaseContext.o obj/ClientContext.o obj/LockClient.o -libverbs -lpthread -o executables/serverCentricLM/LockClient